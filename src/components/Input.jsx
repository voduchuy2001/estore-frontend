  ...
  return (
    <div>
      ...
      <input
        ...
        className={
          error
            ? 'block w-full rounded-lg border border-red-500 bg-red-50 px-4 py-3 text-sm text-red-900 placeholder-red-700 focus:border-red-500 focus:ring-red-500 dark:border-red-500 dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500'
